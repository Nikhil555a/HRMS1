...
function SidebarNotifications({ user }) {
  const navigate = useNavigate();
  const [open, setOpen]               = useState(false);
  const [notifications, setNotifications] = useState([]);
  const [unreadCount, setUnreadCount] = useState(0);
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <div style={{
            ...
            background: unreadCount > 0 ? 'rgba(99,102,241,0.2)' : 'rgba(255,255,255,0.06)',
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            flexShrink: 0, position: 'relative',
          }}>
            <svg viewBox="0 0 24 24" fill="none" stroke={unreadCount > 0 ? '#818cf8' : 'var(--text-muted)'}
              strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="15" height="15">
              <path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/>
              <path d="M13.73 21a2 2 0 01-3.46 0"/>
            </svg>
            {unreadCount > 0 && (
          ...
          <span style={{
            ...
            color: unreadCount > 0 ? '#c7d2fe' : 'var(--text-muted)',
          }}>
            Notifications
          </span>
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          ...
          <svg viewBox="0 0 24 24" fill="none" stroke="var(--text-muted)" strokeWidth="2"
            width="12" height="12" style={{ transition: 'transform 0.2s', transform: open ? 'rotate(180deg)' : 'none' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
              <span style={{
                ...
                display: 'inline-block', animation: 'sidebarPulse 2s infinite',
              }} />
              ...
              {unreadCount > 0 && (
                <button
                  ...
                  style={{
                    ...
                    fontSize: '10px', cursor: 'pointer', fontWeight: 600, padding: '2px 4px',
                  }}
                >
                  Mark all read
                </button>
            ...
            {notifications.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '24px 12px' }}>
                ...
                <p style={{ fontSize: '11px', color: 'var(--text-muted)', marginTop: '4px', opacity: 0.6 }}>
                  Reminders appear 15 min before interviews
                </p>
              </div>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    padding: '9px 12px',
                    cursor: 'pointer',
                    background: notif.isRead ? 'transparent' : `${accent}12`,
                  ...
                  onMouseLeave={e => e.currentTarget.style.background = notif.isRead ? 'transparent' : `${accent}12`}
                >
                  {/* Unread dot */}
                  {!notif.isRead && (
                    <span style={{
                  ...
                  <div style={{
                    ...
                    background: notif.isRead ? 'rgba(255,255,255,0.05)' : `${accent}20`,
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{
                      fontSize: '12px',
                      fontWeight: notif.isRead ? 500 : 700,
                      color: notif.isRead ? 'var(--text-muted)' : 'var(--text)',
                      lineHeight: 1.4,
                      overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap',
                    }}>
                      {notif.title}
                    ...
                    <div style={{
                      ...
                      color: accent, fontWeight: 600, opacity: 0.9,
                    }}>
                      {timeAgo(notif.createdAt)}
                    </div>
                  </div>
  ...
  return (
    <aside className="sidebar" style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{ flexShrink: 0, padding: '0 8px' }}>
        ...
        {/* User footer */}
        <div className="sidebar-footer" style={{ overflow: 'visible', padding: '8px 0' }}>
